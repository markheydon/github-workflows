...
- To permanently exclude a repo from all PM operations (including PRs), add it to `plan/EXCLUDED_REPOS.md` instead.
- To add a newly created repo, decide its tier based on current focus and add a row to the appropriate table.

### For Agents

1. Read this file during Step 2 of `/pm-iteration-plan` and Step 1 of `/pm-backlog-review`.
