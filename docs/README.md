...
- How to set up and use the PM workflow prompts (all `pm-*` prompts explained).
- How to install and customise Copilot agents, skills, and instructions for your own repos.
