...
4. **Install Copilot assets** using `Install-CopilotAssets.ps1` or manually copy `.github/agents/`, `.github/skills/`, `.github/prompts/`, and `.github/instructions/` into your repo. This step covers `.github/` Copilot assets only, so ensure `plan/REPO_PRIORITIES.md` is added separately.
